...
\emph{Rechenregeln}
\index{Winkelfunktionen!Rechenregeln}
 \begin{align}
...
\index{Winkelfunktionen!Trigonometrischer Pythagoras}
\begin{equation}
\sin^2 x+ \cos^2 x =1
  \end{equation}
...
\index{Winkelfunktionen!Umrechnung Grad- <-> Bogenmaß}
