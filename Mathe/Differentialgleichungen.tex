...
\index{Differentialgleichungen!Linear}
\begin{align*}
y_{all}&=y_h+y_p
\end{align*}

\subsection{DG 1. Ordnung}
\index{Differentialgleichungen!1.Ordnung}
\begin{multicols}{2}
...
\index{Differentialgleichungen!2.Ordnung}
\begin{multicols}{2}
...
\index{Differentialgleichungen!Partikuläre Lösungen!Polynom}
...
\index{Differentialgleichungen!Partikuläre Lösungen!Polynom und e-Funktion}
\begin{align*}
&a\lambda^2+b\lambda+c=0\\
...
\index{Differentialgleichungen!Partikuläre Lösungen!sin- und cos Funktion}
\begin{align*}
&a\lambda^2+b\lambda+c=0\\
...
\index{Differentialgleichungen!Partikuläre Lösungen!e-, sin- und cos Funktion}
\begin{align*}
